...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Alex Levinson", "Zulfiqar Ali"]
  spec.email         = ["gen0cide.threats@gmail.com", "zulfiqar@influitive.com"]
  spec.summary       = %q{ActiveJob support for Apartment}
  spec.description   = %q{Enable ActiveJob to work with Apartment multi-tenancy}
  spec.homepage      = "https://github.com/gen0cide/apartment-activejob"
  spec.license       = "MIT"
